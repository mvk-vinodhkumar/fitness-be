...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div id="mySidenav" class="sidenav">
        <div class="">
            ...
            <li id="membership" class="nav-item" data-img="membership" data-toggle="collapse" data-target=".navbar-collapse.show">
                <a href="#member-section">
                    ...
                    <span class="title custom_title">Membership</span>
                </a>
            </li>
            <li id="recipes" class="nav-item" data-img="recipe" data-toggle="collapse" data-target=".navbar-collapse.show">
        ...
        <button class="js-fh5co-nav-toggle fh5co-nav-toggle mar_2 site-navbar-target_mobile" type="button"  aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation"> <span class="oi oi-menu"></span> </button>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <ul class="navbar-nav nav ml-auto">
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#home-section" class="nav-link active"><span>Home</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#about-section" class="nav-link"><span>About</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#services-section" class="nav-link"><span>Services</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#testimonal-section" class="nav-link"><span>Testimonials</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#member-section" class="nav-link"><span>Membership</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#recipes" class="nav-link not-a-section"><span>Recipes</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#contact-section" class="nav-link"><span>Contact</span></a>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#blog" class="nav-link" target="_blank"><span>Blog</span></a>
...
?>
    ...
    <section id="home-section" class="hero">
        ...
        <div class="content">
            ...
            <p class="content_second">We are here for you to enjoy the fitness journey!. Liv Ezy is a community where you learn, get motivated & transform all in a sustainable and easy way.</p>
            <!-- Use a button to pause/play the video with JavaScript -->
            <button class="content_button" data-toggle="modal" data-target="#loginModal" id="myBtn">Join Us</button>
        </div>
    </section>
  ...
  <?php if(isset($_COOKIE['ralcountry'])){ ?>
    ...
    <section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb sec-two-sm " id="about-section">
                ...
                <div class="col-md-12">
                    <div class="master_outside_about">
                        ...
                        <div class="desc_about">
                            Liv Ezy (formerly known as Ral Fitness) was established in April 2019 with a vision to change people’s
                            lives through fitness in the most sustainable and easy way and at the same time to build an online fitness
                            community. We strongly believe that any fitness goal can be achieved without intensive and extreme diets or
                            training routines hence our approach towards nutrition and training is catered to your lifestyle making it easy
                            and sustainable.
                      ...
                      @foreach($testimonials as $testimon)
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center py-4 testimonial_new">
                                ...
                                <div class="text">
                                    <p class="mb-4">{{ str_limit($testimon->details, $limit =100 , $end = '...')  }}</p>
    ...
    <section class="ftco-section pricing-section" id="member-section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-3">
                ...
                <div class="col-md-12 heading-section ftco-animate text-center"> <span class="subheading">Membership Plans</span>



                    <h2 class="mb-2">Individual Membership Plans</h2>
        ...
        <div class="container own-member-main-container" style="margin-bottom: 1rem;">
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <a href="javascript:void(0)" class="more-info m-info-test" data-toggle="modal" data-target="#mem-info" data-id="0"><i class="fas fa-info-circle" style="color:#187FDE;margin-right: 3px;"></i>More Info</a>
                        ...
                        <!-- <label for="test1"><a href="javascript:void(0)" class="more-info m-info-test" data-toggle="modal" data-target="#term_condition" href="javascript:void(0)">Terms & Conditions</a></label> -->
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-3mIndPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['three_months_offer']}}" data-description="3 months plan">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col" style="display: none;">
                ...
                <div class="text-center">
                    ...
                    <span class="price pd-20">
                        ...
                        <span class="number-member"><span class="line-through">
                        ...
                        <em class="monthly-price spl-price"><sup style="color: #000;"><?php echo $currency_icon ?></sup>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary pay__" data-plan="0" data-price="1" data-description="1Rs">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col relative">
                ...
                <div class="text-center">
                    ...
                    <span class="price" style="margin-top:20px;">
                        ...
                        <!-- data-toggle="modal" data-target="#term_condition" add this when subscription enabled -->

                    <span class="excerpt d-block new_tnc"  style="color: #fefefe;" data-plan="{{$prices['six_months_plan_id']}}" data-count="6" data-price="{{$prices['six_months_offer']}}" data-description="6 months plan">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-6mIndPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['six_months_offer']}}" data-description="6 months plan">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <span class="excerpt d-block new_tnc"  data-plan="{{$prices['twelve_months_plan_id']}}" data-count="12" data-price="{{$prices['twelve_months_offer']}}" data-description="12 months plan">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-12mIndPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['twelve_months_offer']}}" data-description="12 months plan">Buy Now</a>
        ...
        <div class="container" style="text-align: justify;text-align-last: center;">
            ...
            <h2 class="mb-2 cp-head">Buddy Membership Plans</h2>
        ...
        <div class="container own-member-main-container" style="margin-bottom: 0;">
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <h2 class="heading">3 Months Buddy Package</h2>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-3mCouPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['three_months_couple_offer']}}" data-description="3 months buddy package">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <h2 class="heading">6 Months Buddy Package</h2>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-6mCouPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['six_months_couple_offer']}}" data-description="6 months buddy package">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <h2 class="heading">12 Months Buddy Package</h2>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-6mCouPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['twelve_months_couple_offer']}}" data-description="12 months buddy package">Buy Now</a>
            ...
            <h2 class="mb-2 cp-head">Live Workout Sessions</h2>



            <p class="plan-brief-info cmp"> All classes are delivered in the comfort of your home using Zoom Video and you can fit one in around your daily schedule. It’s a great way to stay fit and active and an ideal way of getting friends together remotely to have fun in the name of exercise!
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <span class="price pd-20">
                        ...
                        <span class="number-member"><span class="line-through">{{ str_replace('.00','', moneyFormatIndia($prices['one_months_live_workout']))}}/-</span></span>



                        <em class="monthly-price spl-price"><sup style="color: #000;"><?php echo $currency_icon ?></sup>{{ str_replace('.00','', moneyFormatIndia($prices['one_months_live_workout_offer']))}}/-</em>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-1mworkoutPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['one_months_live_workout_offer']}}" data-description="1 month live workout">Buy Now</a>
            ...
            <div class="own-member-item ftco-animate member-col">
                ...
                <div class="text-center">
                    ...
                    <span class="price pd-20">
                        ...
                        <span class="number-member"><span class="line-through">{{ str_replace('.00','', moneyFormatIndia($prices['three_months_live_workout']))}}/-</span></span>



                        <em class="monthly-price spl-price"><sup style="color: #000;"><?php echo $currency_icon ?></sup>{{ str_replace('.00','', moneyFormatIndia($prices['three_months_live_workout_offer']))}}/-</em>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary new_tnc gt-pay-3mworkoutPlan" data-toggle="modal" data-target="#term_condition" data-plan="0" data-price="{{$prices['three_months_live_workout_offer']}}" data-description="3 months live workout">Buy Now</a>
    ...
    <section class="ftco-section insta-feed-section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 text-center ftco-animate">
                    ...
                    <h2><img class="inst_img" src="fitness/images/instagram_new.png"><a class="insta_hover" ref="https://instagram.com/liv.ezyfit/" target="_blank" class="usrid mb-3 new_inst">@liv.ezyfit</a></h2>
    ...
    <section class="ftco-section faq-section " id="faq-section">
        <div class="container">
            ...
            <div class="outside_faq" id="myGroup">
                <a data-target="#faq1" aria-expanded="false" aria-controls="faq1" class="btn btn-info collapse_head" data-toggle="collapse">All you need to know about online coaching.<span class="plus_ryt">+</span></a>
                ...
                <a data-target="#faq2" aria-expanded="false" aria-controls="faq2" class="btn btn-info collapse_head" data-toggle="collapse">What is online coaching?<span class="plus_ryt">+</span></a>
                ...
                <a data-target="#faq3" aria-expanded="false" aria-controls="faq3" class="btn btn-info collapse_head" data-toggle="collapse">Is online fitness coaching worth it?<span class="plus_ryt">+</span></a>
                ...
                <a data-target="#faq4" aria-expanded="false" aria-controls="faq4" class="btn btn-info collapse_head" data-toggle="collapse">What is the difference between and online and in-person coach?<span class="plus_ryt">+</span></a>
                ...
                <a data-target="#faq5" aria-expanded="false" aria-controls="faq5" class="btn btn-info collapse_head" data-toggle="collapse">How to make most of online coaching?<span class="plus_ryt">+</span></a>
                ...
                <a data-target="#faq6" aria-expanded="false" aria-controls="faq6" class="btn btn-info collapse_head" data-toggle="collapse">What to keep in mind while choosing an online fitness trainer?<span class="plus_ryt">+</span></a>
    ...
    <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-7 heading-section text-center ftco-animate"> <span class="subheading" style="color:#fff!important;">Contact Us</span>
                ...
                <div class="col-md-12 order-md-last">
                  ...
                  <form id="contact_form" method="POST" action="/sendmail" class="ftco-animate">
                    ...
                    <div class="contact-info">
                      ...
                      <div class="contact-info-item contact-info-item_new">
                        ...
                        <p><a href="tel:<?php echo $contact_wa?>" ><?php echo $contact_wa?></a></p>
                      ...
                      <div class="contact-info-item">
                        ...
                        <p><a href="mailto:support@livezy.com">support@livezy.com</a></p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" id="full_name" class="form-control" name="full_name" placeholder="Your Full Name" required>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" id="contact" class="form-control" name="contact" placeholder="Contact No." pattern="^[0-9]{10}$" required>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="message" id="message" rows="5" class="form-control" placeholder="Message" required style="width: 100%;"></textarea>
                    ...
                    <div id="contact_captcha_msg" class="form-status-info" style="display: none;">Please check the reCaptcha and try again.</div>
                    ...
                    <div id="contact_success_msg" class="form-status-info" style="display: none;">Information you shared was successfully submitted. Thank you, we'll get back to you soon!</div>
                    ...
                    <div id="contact_failure_msg" class="form-status-info" style="display: none;">Information you shared was not successfully submitted. Please try again!</div>
                    ...
                    <div class="form-group text-center" style="margin: 10px 0 60px;">



                        <input type="submit" value="Send" class="submit-contact-button">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10  copyrights_info">
                        ...
                        <p>Copyright &copy;
                            ...
                            <script>document.write(new Date().getFullYear());</script> | All rights reserved | <a href="/terms-conditions" target="_blank" class="tnc">Terms &amp; Conditions</a> | <a href="/privacy-policy" target="_blank" class="tnc">Privacy Policy | <a href="/cookies-policy" target="_blank" class="tnc">Cookies Policy</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <p>Once you enroll we will contact you within 24 to 48 hours.</p>
    ...
    <div class="modal fade membership-modal" id="term_condition" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
         ...
         <ul style="padding-left:60px;list-style: lower-alpha;">
                ...
                <p>You agree that that you are not permitted to share any of the content licensed under these terms with any other individuals and except for the foregoing limited license, no right, title or interest shall be transferred to you.<p>
    ...
    <script src="fitness/js/custom.js?v6"></script>
    <style>
        .loader-css{
            position: absolute;
            top: 40%;
    ...
    <div class="loader-css">
        <img class="img-responsive load-img" src="fitness/images/loader.gif">
    </div>
    <script>
      ...
      <div class="modal fade modal_top" id="location-sel-modal" role="dialog" data-keyboard="false" data-backdrop="true">
          ...
          <div class="modal-dialog" role="document">
              ...
              <div class="modal-content modal_top_content">
                  ...
                  <div class="modal-body">
                      ...
                      <p class="intro-text">Please select your <strong>Country</strong> and <strong>State</strong> to proceed</p>
                      ...
                      <form action="" method="post" id="countryModal">



                          <div class="form-group country-wrap">
                              ...
                              <select name="sel_country" id="sel_country" class="form-control" required>
                                  ...
                                  <option {{(isset($_COOKIE['ralcountry'])&& $_COOKIE['ralcountry']=='INDIA')?'selected':''}} value="INDIA">India</option>



                                  <option {{(isset($_COOKIE['ralcountry'])&& $_COOKIE['ralcountry']=='Other Countries')?'selected':''}} value="Other Countries">Other Countries</option>
                          ...
                          <div class="form-group state-wrap">
                              ...
                              <select name="sel_state" id="sel_state" class="form-control" required>
                          ...
                          <button type="submit" class="btn btn-submit">Explore Website</button>
    ...
    <script>
        ...
        <?php }else{ ?>
          ...
          var ralcountry= '<?php echo $_COOKIE['ralcountry'] ?>';



          var ralstate= '<?php echo isset($_COOKIE['ralstate'])?$_COOKIE['ralstate']:'' ?>';



          if( ralcountry == 'INDIA' || ralcountry == '' ){
              ...
              $('#sel_state option[value="'+ralstate+'"]').attr("selected", "selected");
          ...
          $('.pay__').click(function (e) {
              ...
              var plan_desc=$(this).attr('description');
              if ($(this).attr('plan')==0) {
                ...
                $.ajax({
                    ...
                    url: '/ajax/generateOrder?inr='+parseFloat($(this).attr('price'))*parseFloat(100),
                              ...
                              success: function (response1) {
                                ...
                                console.log(response1 ,'from HNADELE');
                                  ...
                                  $.ajax({
                                      ...
                                      url: '/sendInvoice?plan_id='+response1.data+'&desc='+plan_desc,
                ...
                $.ajax({
                    ...
                    url: '/createSubscription?plan_id='+$(this).attr('plan')+'&count='+$(this).attr('count'),
                        ...
                        var options = {
                            ...
                            "handler": function (response){
                                ...
                                $.ajax({
                                    ...
                                    url: '/sendSubscriptionInvoice?plan_id='+response.razorpay_payment_id+'&subscription_id='+sub+'&desc='+plan_desc,
          ...
          $('.olpay__').click(function (e) {
              ...
              var options = {
                ...
                "amount": parseFloat($(this).data('price'))*parseFloat(100), // 2000 paise = INR 20
                ...
                "handler": function (response){
                    ...
                    $.ajax({
                        ...
                        url: '/sendInvoice?plan_id='+response.razorpay_payment_id,
                  ...
                  $('.res_amt').html('<strong><?php echo $currency_icon ?></strong>'+$($this).data('price')+'/-')
              ...
              $.ajax({
                  ...
                  url: '/createSubscription?plan_id='+$(this).data('plan'),
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="first_login_mod">
                        ...
                        <form>
                            <div class="form-group">
                                <!-- <input id="telNo" onkeypress="return isNumberKey(event)"  onfocusout="isMobileAvail()" name="telNo" type="tel" size="20" minlength="13" maxlength="14" placeholder="+91 90909 90909" /> -->
                                <input id="telNo" onkeypress="return isNumberKey(event)"  onfocusout="isMobileAvail()" name="telNo" type="tel" size="20" minlength="12" maxlength="12" placeholder="9090990909" />
                            </div>
                            <div class="form-group">
                ...
                <div class="password_mod">
                        ...
                        <div class="containers">
                            ...
                            <p class="resend_text f_p">Forget password</p>
                        </div>
                </div>
            </div>
        </div>
