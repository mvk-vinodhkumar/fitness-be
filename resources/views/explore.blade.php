            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7 text-center heading-section ftco-animate">
                        <span class="subheading">Explore our</span>
                        <h2 class="">RECIPES</h2>
                    </div>
                </div>
                            ...
                            @if(!isset($_GET['q'])&&!isset($_GET['recipe_search']))
                              ...
                              @else
                                  <div class="all_recipes">
                                        <a href="/recipes"> <i class="fas fa-chevron-left"></i> All recipes</a>
                                  </div>
                              @endif
                          </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <form id="contact_form" method="POST" action="/sendmail" class="ftco-animate">
                                ...
                                <div class="row mt-1 form-group d-flex flex-column pl-3">
                                    <input type="tel" id="txtPhone" class="txtbox contact-form-phone" style="height:52px !important;" placeholder="Contact Number" name="contact" required/>
                                ...
                                <div class="row mt-4 mb-5 d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary btn-lg btn-block mb-2 ml-2 mr-2">Submit</button>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-10 text-center copyrights_info">
                            <p>Copyright &copy;
                                <script>document.write(new Date().getFullYear());</script> | All rights reserved | <a href="/tnc/tnc.pdf" target="_blank" class="tnc">Terms &amp; Conditions</a> | <a href="/privacy-policy" target="_blank" class="tnc">Privacy Policy</a>
                        </div>
                        <div class="col-md text-right footer-icon-mob">
                            <p>
                                <a href="https://instagram.com/livezy.fitness/" target="_blank"><span class="icon-instagram own-inst-icon"></span></a>
                                <a href="https://www.facebook.com/raldsouzafitness/" target="_blank"><span class="icon-facebook own-facebook-icon "></span></a>
