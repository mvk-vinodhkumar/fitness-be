...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div id="mySidenav" class="sidenav">
        <div class="">
            ...
            <li id="home" class="nav-item active" data-img="home">
                ...
                <span class="icon"><img class="img-responsive responsive-logos" src="insta_img/dashboard_white/home_white.png"></span>
            ...
            <li id="coach" class="nav-item" data-img="recipe" data-toggle="collapse" data-target=".navbar-collapse.show">
                <a href="#coach-div">
                <span class="icon"><img class="img-responsive responsive-logos" src="insta_img/dashboard_black/meet-the-team.png"></span>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-center" id="ftco-nav">
                <ul class="navbar-nav nav ml-auto">
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show"><a href="#live-workouts" class="nav-link not-a-section" id="live_workouts"><span>Live Workout</span></a></li>
    ...
    <section id="home-section" class="hero">
        ...
        <video playsinline autoplay muted loop id="myVideo">
            <source src="/fitness/images/webiste_video.mp4" type="video/mp4">
        </video>
        ...
        <div class="content">
            ...
            <div class="row d-flex flex-row" style="width:100%;">
                <button class="content_button mr-2" data-toggle="modal" data-target="#loginModal" id="myBtn">Join Us</button>
    ...
    <section class="ftco-section ftco-services-2" id="services-section">
        <div class="container">
            <div class="col-md-12 text-center ftco-animate mb-4">
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center py-4 testimonial_new">
                                ...
                                <div class="text">
                                    <p class="mb-4">{{ \Illuminate\Support\Str::limit($testimon->details, $limit =110 , $end = '...')  }}</p>
    ...
    <!-- new contact section -->
    <section class="ftco-section ftco-no-pb mx-5 text mt-5">
        <div class="d-flex row flex-col">
            ...
            <div class="d-flex mt-3 justify-content-around flex-wrap">
                <div class="col-md-6 px-5">
                    <h1 class="contact-head col-md-8">Coaching that is tailored to your lifestyle and goals.</h1>
        ...
        <div class="whats-app-img">
            <div class="card support-card p-3" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                <div class="arrow d-flex justify-content-end mr-2">
                    <span class="clickable close-icon" data-effect="fadeOut"><i class="fa fa-sort-desc fa-lg"></i></span>
                </div>
                <div class="card-body p-4 support-banner">
                    <span>
                        ...
                        <div class="row d-flex justify-content-center">
                            <button type="button" class="btn btn-success px-5 btn-wa"><i class="fa-brands fa-whatsapp fa-lg"></i> Chat on Whatsapp</button>
                        </div>
                    </span>
                </div>
            </div>
    ...
    <div class="modal fade membership-modal modal-child" id="mem-info" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop-limit="1">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-wa, .whatsapp-icon-div').on('click', function() {
                window.open('https://api.whatsapp.com/send/?phone='+whatsapp_no+'&text=Hey%2C%20I%20would%20like%20to%20know%20more%20about%20the%20online%20fitness%20coaching&app_absent=0', '_blank')
            })
                    ...
                    <div class="d-flex flex-column text-center">
                        <form autocomplete="off">
                            <div class="form-group">
                                ...
                                <input id="telNo" onkeypress="return isNumberKey(event)" onfocusout="isMobileAvail()" name="telNo" type="tel" size="20" minlength="12" maxlength="12" placeholder="Mobile Number" autocomplete="off"/>
                            </div>
                            <div class="form-group">
                                <input id="userEmail" name="telNo" type="email" placeholder="Email" autocomplete="off"/>
                            </div>
                            <!-- <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#mob_password').keydown(function(e) {
            if (e.keyCode == 13) {
                $('#otp_login_with_pwd').click();
            }
        })
