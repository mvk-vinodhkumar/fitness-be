                                        ...
                                        <div class="ques-box">
                                            ...
                                            <?php
                                                    ...
                                                    case 'radio':
                                                        ...
                                                        ?> 
                                                            <p {{ $data[$i]->id==17?'class=radio_style':''}}><input class="ques_checkbox" onclick="handleClick(this);"  value="{{$opt_value[$k]}}" type="radio" name="radio_{{$data[$i]->id}}" /> 
                        ...
                        <fieldset style="background:#6f6f6f!important;">
                            ...
                            <br><br>
                                <div class="row justify-content-center">
                                    <div class="col-3" style="text-align:center;"> <img src="/insta_img/tick-inside-circle_s.png" class="fit-image"> </div>
                                </div> 
