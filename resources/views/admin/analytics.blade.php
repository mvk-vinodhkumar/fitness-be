...
<head>
    ...
    <style>
        ...
        .analytics_liv_ret, .finance_liv_ret {
            width: 150px;
        }
                    ...
                    <ul class="p_ul">
                        ...
                        <?php } else { ?>
                            ...
                            <?php if(Session::get('role-id')==2 && Session::get('team')=='Internal') { ?>
                                <li id="admin_analytics" class="nav-item menu_li active_menu">
                ...
                <div class="col-md-10 right_panel">
                    <div class="admin_analytics p_d">
                        ...
                        <div class="col-md-12 neda live_cal" id="avo">
                            <div class="analy">
                                <div class="top_analy">
                                    <label for="from_liv_avo" class="mr-2">From: </label>
                                    <input type="date" class="form-control analytics_liv_ret" id="from_liv_avo">
                                    <label for="to_liv_avo"><span class="avo_span">To: </span></label>
                                    <input type="date" class="form-control analytics_liv_ret" id="to_liv_avo">
                                </div>
                                <br>
                        ...
                        <div class="col-md-12 neda live_cal" id="avf">
                            <div class="analy">
                                <div class="top_analy">
                                    <label for="from_liv_fvo" class="mr-2">From: </label>
                                    <input type="date" class="form-control finance_liv_ret" id="from_liv_fvo">
                                    <label for="to_liv_fvo"><span class="fvo_span">To: </span></label>
                                    <input type="date" class="form-control finance_liv_ret" id="to_liv_fvo">
                                </div>
                                <br>
...
<script>
    ...
    var coach_oper_analytics = '';

    // Returns Coach retension data
    $.ajax({
        type:'GET',
        global:true,
        async:false,
        url: 'get_retension_data',
        success: function(data) {
            coach_oper_analytics = data;
        }
    });
