            ...
            <div class="col-md-12 p_d_n">
                ...
                <div class="col-md-2 left_panel">
                    ...
                    <ul class="p_ul">
                        ...
                        <?php } else {?>
                        <li id="paid_members" class="nav-item menu_li active_menu">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <select id="select_oper_activity" class="form-control">
                                    ...
                                    <option value="add_payment">Create Payment Record</option>
                                </select>
                            </div>
                            <?php } ?>
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span>Add New User as a Paid Member</span></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="radio" name="user_add" value="exsisting" class="add_main"> Exsisting User
                        </div>
                        <div class="col-md-6">
                            <input type="radio" name="user_add" value="new" class="add_main"> New User
                        </div>
                    </div>
                    <div class="row exsisting">
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-12">
                            <select id="user_select" data-placeholder="Select Username" class="form-control i_s c_t_i chosen-select" onchange="onUser_select()">
                                <option value=""></option>
                            </select>
                        </div>
                        <!-- <div class="col-md-1"></div> -->
    ...
    <div class="modal fade" id="add_payment" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><span>Create User Payment Record</span></h4>
                </div>
                <div class="modal-body">
                    <div class="row exsisting">
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-12">
                            <select id="user_select_payment" data-placeholder="Select Username" class="form-control i_s c_t_i chosen-select" onchange="onUser_select_payment()">
                                <option value=""></option>
                            </select>
                        </div>
                        <!-- <div class="col-md-1"></div> -->
                    </div>
                    <div class="payment_user_html" style="margin-top: 12px;">
    ...
    <div class="modal fade" id="membership_extension" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><span>Extend Membership</span></h4>
                </div>
                <div class="modal-body">
                    <div class="row exsisting">
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-12">
                            <select id="user_select_extend" data-placeholder="Select Username" class="form-control i_s c_t_i chosen-select" onchange="onUser_select_extend()">
                                <option value=""></option>
                    ...
                    <div class="extend_user_html" style="margin-top: 12px;">
    ...
    <div class="modal fade" id="admin_pause" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><span>Pause Create/Extension</span></h4>
                </div>
                <div class="modal-body">
                    <div class="row exsisting">
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-12">
                            <select id="user_select_pause" data-placeholder="Select Username" class="form-control i_s c_t_i chosen-select" onchange="onUser_select_pause()">
                                <option value=""></option>
                    ...
                    <div class="pause_user_html" style="margin-top: 12px;">
    ...
    <div class="modal fade" id="change_start_date" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><span>Plan Start Date Change</span></h4>
                </div>
                <div class="modal-body">
                    <div class="row exsisting">
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-12">
                            <select id="user_select_change_start_date" data-placeholder="Select Username" class="form-control i_s c_t_i chosen-select" onchange="onUser_select_csd()">
                                <option value=""></option>
                    ...
                    <div class="pause_user_html_change_start">
    ...
    <div class="modal fade" id="update_status" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">You are updating the status of <span id="s_u_t">Chandan Kumar (user id:
                            20345)</span></h4>
                </div>
                <div class="modal-body">
                    <div class="first_f_step">
...
// Added by Furkan for Admin Ops on New Paid Members
    ...
    function onUser_select_payment() {

        var user_id=$('#user_select_payment').val();
        // console.log('Selected user_id: ' + user_id);
        if(user_id) {
            $.ajax({
                type:'POST',
                data:{'_token': '{{ csrf_token() }}','username':user_id},
                url:'get_users_data_for_payment',
                success:function(data){
                    $('.payment_user_html').html('');
                    if(data){
                        $('.payment_user_html').html(data);
                    }
                }
            });
        }
...
$(document).ready(function() {
    ...
    $('.member_tab_view').on('click',function(){
        ...
        //     $.ajax({
        //         type:'GET',
        //         url:'get_renewal_data',
        //         success:function(data){
        //             console.log('From Success of Get Renewal Data');
        //             $('#renewal_data').find('tbody').html(data);
        //         }
        //     });
        // }
    });
            ...
            $.ajax({
                ...
                success:function(data) {
                    if(selected_operation == 'add_user') {
                        ...
                        // console.log('Data append for add_payment');
                        $('#user_select_payment').html(data);
                        $('#user_select_payment').trigger("chosen:updated");
                    }
                }
            });
        }
    ...
    $("#user_select_payment").chosen({ width:"100%" });
    ...
    var renewal_super_data = '';

    // Returns all the renewal users data
    $.ajax({
        type:'GET',
        global:true,
        async:false,
        url: 'get_renewal_data',
        success: function(data) {
            // console.log("Success of get_renewal_data");
            renewal_super_data = data;
        }
    });
    ...
    var renewal_data = $('#renewal_data').DataTable( {
        ...
        columns: [
            ...
            { data: "previous_plan"},
            { data: "previous_team"},
            { data: "previous_head_coach"},
            { data: "previous_plan_start_date"},
            { data: "created_at"}
        ]
    });
