                    ...
                    <ul class="p_ul">
                        ...
                        <?php } else { ?>
                            ...
                            <?php if(Session::get('role-id')==2 && Session::get('team')=='Internal') { ?>
                                ...
                                <li id="team_details" class="nav-item menu_li active_menu">
...
<script>
    ...
    // Defining team_coach_data globally
    var team_coach_data = '';
    ...
    function create_team() {
        ...
        $.ajax({
            type: 'GET',
            url: 'get_coach_firstName',
            success: function(response){
                $('#coach_select').append(response);
            }
        })
