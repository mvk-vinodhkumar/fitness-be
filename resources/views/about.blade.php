...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <!-- what we do -->
    <section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb sec-two-sm mt-5" id="about-section" style="margin-top:80px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="master_outside_about">
                        <div class="outside_about">
                            <div class="about_logo">
                                <img class="a_l_s" src="fitness/images/png2.png" />
                            </div>
                        ...
                        <div class="desc_about">
                            At Liv Ezy (formerly Ral Fitness), we are dedicated to helping you make positive and lasting changes to your lifestyle and health. We understand that when embarking on a new journey, it's important to focus on the present while keeping your end goal in sight. Here, you will have the best fitness coaches providing nutritional guidance and training routines that suit your lifestyle. We believe that fitness can be done sustainably with the right support while ensuring you are on a flexible routine.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="{{ url('/images/about/pic1.JPG') }}" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ url('/images/about/pic2.PNG') }}" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ url('/images/about/pic3.JPG') }}" alt="Third slide">
          </div>
        </div>
    ...
    <section class="ftco-section insta-feed-section" style="margin-top:40px !important;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center ftco-animate">
                    <span class="subheading new_inst">Follow Us</span>
                    <h2><img class="inst_img" src="fitness/images/instagram_new.png"><a class="insta_hover" href="https://www.instagram.com/livezy.fitness/" target="_blank" class="usrid mb-3 new_inst">@livezy.fitness</a></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--<script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script>
                        <iframe src="https://cdn.lightwidget.com/widgets/46be91f0e2cf512697e1174744d7432d.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;bSign Up:0;overflow:hidden;"></iframe>-->
                    <div class="container">
                        <div class="row ftco-animate justify-content-center">
                            <div class="col-md-12">
                                <div class="carousel-insta owl-carousel ftco-owl">
                                    <div class="item">
                                        <div class="testimony-wrap text-center py-4 ">
                                            <div class="user-img" style="background-image: url(insta_img/12.JPG)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-wrap text-center py-4 ">
                                            <div class="user-img" style="background-image: url(insta_img/13.JPG)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-wrap text-center py-4 ">
                                            <div class="user-img" style="background-image: url(insta_img/15.JPG)">
                                                <i class="fa fa-heart h_postion" aria-hidden="true"></i>
                                                <i class="fa fa-comment h_position" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-wrap text-center py-4 ">
                                            <div class="user-img" style="background-image: url(insta_img/14.JPG)"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="testimony-wrap text-center py-4 ">
    ...
    <!-- new contact section -->
    <section class="ftco-section ftco-no-pb mx-4 text mt-3 mb-3" id="contact-section">
