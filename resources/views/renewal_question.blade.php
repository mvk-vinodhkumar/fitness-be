                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    <div class="heading-quest">
                                        {{$data[$i]->section}}
                                        <p class="sub_new_head">Thank you for renewing with us, please fill in these details so we can upgrade your plan accordingly.</p>
                                    </div>
                                    <?php
                                    }
                                ?>
                                        ...
                                        switch($data[$i]->type)
                                        {
                                            ...
                                            <?php
                                                ...
                                                case 'checkbox':
                                                    ...
                                                    ?>
                                                        <p><input class="ques_checkbox ques_{{$data[$i]->id.'_'.$data[$i]->required}}"  type="checkbox" value="{{$opt_value[$k]}}" name="checkbox_{{$data[$i]->id}}" />
                                                            <span class="radio_text">
                                                                {{$opt_value[$k]}}
                                                            </span>
                                                        </p>
                ...
                if(i==7){
                    if($('.question_7').css('display')=='block'){
                        ...
                        if(ques_val==undefined){
                                $('.question_'+i+' .outer-box-ques').addClass('error_border');
                                condition=false;
                                toastr.error('Please tell us if you have coach in mind');
                                return false
                            }
                    }
                }
                if(i==8){
                    if($('.question_8').css('display')=='block'){
                        console.log('Q8',ques_val,id_ques)
                        if(ques_val==undefined){
                                $('.question_'+i+' .outer-box-ques').addClass('error_border');
                                condition=false;
                                toastr.error('Please specify the coach name');
                                return false
                            }
                    }
                }
...
function handleClick(myRadio) {
    ...
    if(myRadio.value=="Yes I have")
        $('.question_8').css('display','block');
    if(myRadio.value=="No")
        $('.question_8').css('display','none');
}
</script>
