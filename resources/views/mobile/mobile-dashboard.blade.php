...
<head>
  ...
  <link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 621px) and (device-height: 1104px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 834px) and (device-height: 1112px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 834px) and (device-height: 1194px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
<link href="fitness/mobile/icon_splash/144x144.png" media="(device-width: 1024px) and (device-height: 1366px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" /> -->
...
<style>
    ...
    .header-ques{
        background:url('fitness/images/question_banner.png')!important;
...
<?php
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center header_logo">
      ...
      <h1 class="logo mr-auto" onclick="$('#dashboard').click()"><a href="#"><img class="img-responsive logo_img mob_lg" src="insta_img/Navbar.png"></a></h1>
          ...
          <li>
              <div class="loggin_div">
                  ...
                  <!-- <span class="location">●</span>Bangalore -->
                    <span class="location" ><img class="location_flag" src="https://ipdata.co/flags/<?php echo strtolower($users->short_country_name);?>.png" alt="Smiley face"></span><span class="flag_text"><?php //echo $users->city;?></span>
                  </div>
                  <div class="logged-out common_login login2" id="u_login" >
                    <div class="dropdown">
                        <img class="img-responsive rounded_img_onboarding login_img_height dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="<?php echo Session::get('image')?Session::get('image'):'fitness/images/default_image.svg'?>"/>
  ...
  <?php
    ...
    ?>
        <div class="support_email">
            <a href="mailto:support@livezy.com"><img src="fitness/images/email.png" style="height:30px;" class="img-responsive new_email"></a>
        </div>
    <?php
    }
?>
...
<main id="main">
    ...
    <div class="main_dashboard">
        ...
        ?>
            <div class="renew_bar">
                <div><img src="fitness/images/warning_renew.png" class="img-responsive warning_renew" /></div>
                <div class="renew_desc">
                    Your current plan will expire soon. Kindly renew on {{ $users->plan_start_date ? $users->plan_end_date : 'XX/XX/XXXX' }} to continue your fitness journey with us.
                </div>
        ...
        <section  class="p_d dashboard">
            <div class="container new_web" data-aos="fade-up" style="padding:0px;">
            ...
            ?>
                <div class="banner_img" onclick="$('#package_bought').click()">
                    <div class="i_diwali">
                        <img src="fitness/images/Diwali-post_dahsboard.png" class="img-responsive nd_p" />
                    </div>
                    <div class="t_diwali">
                        <p class="rm_headeer_new_date">28<sup>th</sup> Oct - 09<sup>th</sup> Nov, 2021</p>
                        <p class="rm_headeer_new">Hey {{$users->name}}, this Diwali renew your subscription at exclusive prices!</p>
                        <div class="avl_btn" >Avail Now</div>
                    </div>
                </div>
            <?php } ?>

            <?php if($users->user_status > 3 && $users->user_status < 8 && $users->member_type!='Live Session'){ ?>
                ...
                <div class="container-fluid start_outside">
                    <div class="tracker_box">
                        ...
                        <div class="p_tracker_img p_tracker_img_active"><i class="fa fa-check" aria-hidden="true"></i></div>
                    </div>
                    <div class="tracker_box">
                        <div class="p_tracker">Physique</div>
                        <div class="p_tracker_img"><i class="fa fa-male" aria-hidden="true"></i></div>
                    </div><div class="tracker_box">
                    ...
                    <div class="tracker_progress_bar">
                        <?php
                            ...
                            if($users->user_status==4){
                                $progress_width='27%';
                            }else if($users->user_status==5){
                                $progress_width='57%';
                            }else if($users->user_status==6){
                                $progress_width='85%';
                            }else if($users->user_status==7){
                                $progress_width='125%';
                            }
                        ?>
            ...
            <?php
                ...
                <?php if(!empty($users->team)) { ?>
                    ...
                    <div class="container-fluid first_card">
                        ...
                        if($future_question){
                        ?>
                        <div class="btn_p"><button class="complete_p_b std" >Start date chosen <?php echo $users->questionaire_start_date?date('d-m-Y',strtotime($users->questionaire_start_date)):'';?></button></div>
                        <?php
                        }else{
                        ?>
                        <?php if($users->member_type!='Live Session'){?>
                        <div class="font_ten_style n_p_n"><b>Please Note:</b> It will take us at least 48 hours to customize your diet & workout plan</div>
                        <?php } ?>
                        <div class="btn_p"><button class="complete_p_b std btn-calendar" id="p_s_c">Choose Your Start Date</button></div>
                        <?php } ?>
                    </div>
                    <?php } ?>
                    <?php }  else if($users->member_type === 'Live Session') { ?>
                    <div class="container-fluid first_card">
                        <div class="font_ten_style"><?php echo ucfirst($users->plan);?> Membership</div>
                        <div class="font_ten_style"><?php echo ucfirst($users->member_type);?> Plan</div>
                        <div class="btn_p"><button class="complete_p_b std btn-calendar" id="p_s_c">Choose Your Start Date</button></div>
            ...
            <?php } else {
                if($users->user_status==9){ ?>
                    <div class="profile_ongoing">
                        <div class="img_sec tz">
                            <div class="img_div">
                                <img class="img-responsive rounded_img_onboarding big_img" src="<?php echo Session::get('image')?Session::get('image'):'fitness/images/default_image.svg'?>"/>
                            </div>
                        </div>
                        <div class="membership_onboarding tz">
                            ...
                            if($users->member_type!='Live Session'){
                            ?>
                            <a href="<?php echo $users->plan_doc_link;?>">
                                <div class="m_d_s_d"><img src="fitness/images/view_plan.png" class="v_p_f"><span class="v_p">View Plan</span></div>
                            </a>
                            <?php
                            }
                            ?>
                    ...
                    <div class="container-fluid second_card">
                        <div class="d_oniut">
                            ...
                            <div class="dsc" data-bg="#fff" data-title="{{$user_workday?$user_workday['user_plan_left_day']:0}} Days Left" data-donutty data-radius=40 data-thickness=8 data-circle=true data-padding=0 data-round=true data-color="#5CE722" data-value="{{$user_workday?$user_workday['user_complete_percentage']:0}}">
                            </div>
                        </div>
                        <div class="ongoing_membership">
                            ...
                            <div class="third_o_m" style="margin-top:22px;">Start Date: {{$users->plan_start_date?$users->plan_start_date:'XX/XX/XXXX'}}</div>
                            <div class="third_o_m">End Date: {{$users->plan_start_date?$users->plan_end_date:'XX/XX/XXXX'}}</div>
                        </div>
                    </div>
                    <?php
                            ...
                            <div class="upcoming_pause_carousel">
                                ...
                                <div class="first_box_upcoming_pause">
                                    ...
                                    <div class="outside_date_pause">
                                        ...
                                        <button class="cancel_future_pause" onclick="cancel_pause('{{$upcoming_pause[$u_p]->id}}','{{$upcoming_pause[$u_p]->username}}','{{$upcoming_pause[$u_p]->start_date}}','{{$upcoming_pause[$u_p]->end_date}}','{{$upcoming_pause[$u_p]->days}}')">Cancel</button>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="container-fluid new_padding new_live_sess_hide" style="margin-top:30px;">
                            <div class="liv_carousel_outside">
                                <div class="first_liv_carousel">
                                    ...
                                    <div class="timezone_txt">Time Zone - {{isset($_COOKIE['user_time_zone'])?$_COOKIE['user_time_zone']:'Asia/Kolkata'}}</div>
                                </div>
                            ...
                            $day_t=date('D',strtotime($second_tz->format('Y-m-d')));
                                    ...
                                    <div class="filter_{{$live_session_data[$i]->session_name}}" data-session="{{$live_session_data[$i]->session_name}}">
                                        <div class="f_live_sess">
                                            <img class="l_s_i_img_today" src='fitness/images/{{$live_session_data[$i]->session_name}}.png'>
                                        </div>
                                        ...
                                        <div class="t_live_sess">
                                            ...
                                            if($users->user_status==8 || ($users->user_status==1)){
                                                if($btn_a){
                                                    ?>
                                                            <button data-is_join="{{$is_join}}" onclick="zoom_start(this)" data-sessionName="{{$live_session_data[$i]->session_name}}" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="true" data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn_today bks_c {{$today_book_date==$loop_date?'today_date':' '}}">Cancel</button>

                                                    <?php
                                                }else{
                                                    if($live_session_data[$i]->total_seat==$live_session_data[$i]->booked_seat){
                                                        ?>
                                                            <button style="background:gray;" title="All Slot Booked" data-sessionName="{{$live_session_data[$i]->session_name}}" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="false" data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn_today {{$today_book_date==$loop_date?'today_date':' '}}">Book Now</button>
                                                        <?php
                                                    }else{
                                                        ?>
                    ...
                    if(empty($users->team) && $users->member_type != 'Live Session') {
                        if($users->admin_assign_coach == 1) { ?>
                            ...
                            <?php
                                ...
                                <div class="container-fluid first_card">
                                    ...
                                    <div class="font_ten_style"><?php echo ucfirst($users->member_type); ?> Plan</div>
                                    <div class="btn_p">
                                        <button class="complete_p_b std btn-calendar" id="p_s_c">
                        ...
                        <div class="slick-carousel mb-4" style="margin:6px;">
                                ...
                                <div class="row" style="margin:0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="nds_h font_recipe">Fruit Parfait!🍉🥭</div>
                                        <div class="nds_h font_recipe r_s"><button onclick="$('#recipes').click()" class="view_more_recipe">View more</button></div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin:0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="nds_h font_recipe">Mango Yogurt 🥭</div>
                                        <div class="nds_h font_recipe r_s"><button onclick="$('#recipes').click()" class="view_more_recipe">View more</button></div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin:0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="nds_h font_recipe">Overnight Oats 🥣</div>
                                        <div class="nds_h font_recipe r_s"><button onclick="$('#recipes').click()" class="view_more_recipe">View more</button></div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin:0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="nds_h font_recipe">Chocolate Chip Banana Pancakes 🍫🥞🍌</div>
                                        <div class="nds_h font_recipe r_s"><button onclick="$('#recipes').click()" class="view_more_recipe">View more</button></div>
                                    </div>
                                </div>
            ...
            ?>
                    ...
                    <div class="row" id="csb2" style="margin-top:10px; padding:10px;">
                    ...
                    <div class="container-fluid second_card" style="padding-bottom:30px !important;">
                        <div class="d_oniut">
                            <div class="left_d_b">
                                <div class="left_d legend_c_text">
                                    {{ $user_workday ? $user_workday['user_plan_left_day'] : 0 }}
                        ...
                        <div class="ongoing_membership" style="margin-top: -42% !important;">
                            ...
                            <div class="first_o_m"><?php echo ucfirst($users->plan); ?> Membership</div>
                            <div class="second_o_m" style="margin-top:0px !important;"><?php echo ucfirst($users->member_type); ?> Plan</div>
                        ...
                        <div class="first_box_package">
                            <div class="row row_p">
                                <div class="opal">
                                    ...
                                    <div class="row ml-0 mr-0" style="margin-bottom: 10px; font-size: 1rem;">
        ...
        <section class="p_d live_session">
            <div class="liv_parent">
                    <div class="tz">Time Zone- {{isset($_COOKIE['user_time_zone'])?$_COOKIE['user_time_zone']:'Asia/Kolkata'}}</div>
                ...
                <?php
                    ...
                    for($i=0;$i<sizeof($live_session_data);$i++){
                        ...
                        <div class="live_sess_block filter_{{$live_session_data[$i]->session_name}}" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->session_name}}">
                            <!-- <div class="liv_img">
                            ...
                            <div class="ol_liv ol_liv_right">
                                <div class="inside_live_btn">
                                    ...
                                    if($users->user_status==8 || ($users->user_status==1)){
                                        if($btn_a){
                                            ?>
                                                    <button data-is_join="{{$is_join}}" onclick="zoom_start(this)" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="true" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn bks_c {{$today_book_date==$loop_date?'today_date':' '}}">Cancel</button>

                                            <?php
                                        }else{
                                            if($live_session_data[$i]->total_seat==$live_session_data[$i]->booked_seat){
                                                ?>
                                                    <button  title="All Slot Booked" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="false" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn {{$today_book_date==$loop_date?'today_date':' '}}">Book Now</button>
                                                <?php
                                            }else{
                                                ?>
                                                    <button onclick="zoom_start(this)" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="false" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn {{$today_book_date==$loop_date?'today_date':' '}}">Book Now</button>
                                        ...
                                        ?>
                                            <button onclick="static_msg('You can not book live sessions if your plan is on pause')" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="false" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn {{$today_book_date==$loop_date?'today_date':' '}}">Book Now</button>
                                        <?php
                                        ...
                                        ?>
                                            <button onclick="static_msg('Your plan has not started yet')" data-start_date="{{$live_session_data[$i]->start_date}}" data-start_time="{{$live_session_data[$i]->start_time}}" data-booked="false" data-sessionName="{{$live_session_data[$i]->session_name}}"  data-session="{{$live_session_data[$i]->id}}" data-url="{{$live_session_data[$i]->session_url}}" data-time="{{$date_tz->format('Y/m/d H:i:s')}}" class="book_live_btn {{$today_book_date==$loop_date?'today_date':' '}}">Book Now</button>
                ...
                <div class="package_carousel">
                    ...
                    <div class="first_box_package">
                        <div class="row row_p">
                            ...
                            <div class="boug_1">
                                <button class="activate_package"
                                    onclick="activate_package('{{ $user_package_data[$u_p]->id }}','{{ $user_package_data[$u_p]->plan_id }}','{{ $user_package_data[$u_p]->type }} {{ $user_package_data[$u_p]->duration }} Plan', 1)">Activate</button>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
    ...
    <div class="filter_bottom">
        <p><b>Filter</b><span class="filter_live_close" style="float:right">x</span></p>

        <div class="all_filter">
            <div class="notif_filter" data-value=" ">All</div>
        </div>
        <hr>
        <p>Session</p>
        <div class="rest_filter">
            <div class="notif_filter" data-value="HIIT">HIIT</div>
            <div class="notif_filter" data-value="SNC">DB SNC</div>
            <div class="notif_filter" data-value="Dance">Dance Fitness</div>
            <div class="notif_filter" data-value="Yoga">Power Yoga</div>
        </div>
    </div>
</main>
<!-- End #main -->
                    ...
                    <div style="padding-left:18px;padding-right:18px;" class="new_partner_data {{$buddy_check?'':'new_partner_data_style'}}">
                        ...
                        <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input_box">
                                        <span class="fa fa-user icon_profile_form"></span>
                                        <input type="text" class="form-control input_css general_form_css" id="p_d_name_1">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input_box">
                                        <span class="fa fa-envelope icon_profile_form"></span>
                                        <input type="text"  id="p_d_email_1" class="form-control input_css general_form_css">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input_box">
                                        <!-- <?php echo $users->dob?'disabled':' ';?> <span class="fa fa-user icon_profile_form"></span> -->
                                        <input id="telNo_partner" onkeypress="return isNumberKey(event)"  name="telNo" type="tel" size="20"  minlength="13" class="form-control input_css general_form_css">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<div class="modal fade membership-modal" id="mem-info2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title">Live Workout Sessions</h5>



                <button type="button" class="close modal_close2" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                <!-- <div class="container-fluid" style="margin-bottom: 1rem">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="intro-para">We conduct sessions at the following time slots:<br>7 am, 8 am, 9 am, 10 am, 6 pm and 8 pm.</p>
                    ...
                    <!-- <ul>
                        ...
                        <li>Yoga at 9am on Monday, Wednesday & Friday.</li>



                        <li>Hiit bodyweight workouts are at 7am, 8am, 6pm & 8pm from Monday - Saturday.</li>



                        <li>SnC at 10am from Monday - Saturday.</li>
                ...
                <div class="membership-modal-prog-fea">
                    <p class="ndx">Each session lasts for a total of 60 minutes including warm up and cool down. We have a wide variety of workout formats available round the clock in all time zones, such as:</p>

                        <ul>
                            <li>HIIT - High Intensity Interval Training</li>
                            <li>SnC - Strength & Conditioning</li>
                            <li>Power Yoga</li>

                        </ul>
                    <h3>Please keep these in check before you join the session :</h3>
                    ...
                    <ul>
                        ...
                        <li>Login with your original name.</li>



                        <li>Video should be turned on.</li>



                        <li>Audio should be muted during the session.</li>
        ...
        <div class="modal-content" style="border-radius:8px;">
            <div class="modal-body">
                <div class="sec_liv_book modal_body_content">
                    <p class="e_f t_r ef_rh" style="text-align:center">Rate your intro call with coach {{$users->head_coach}}</p>
                    <div class="e_f ef_r" id="element_emoji" style="text-align:center">
                        <fieldset class="rating">
                            <input type="radio" id="star5" name="rating" class="emotion-style-element_custom" value="5"><label class="full" for="star5" title="Awesome - 5 stars"></label>
                            <input type="radio" id="star4half" name="rating" class="emotion-style-element_custom" value="4.5"><label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>
                            <input type="radio" id="star4" name="rating" class="emotion-style-element_custom" value="4"><label class="full" for="star4" title="Pretty good - 4 stars"></label>
                            <input type="radio" id="star3half" name="rating" class="emotion-style-element_custom" value="3.5"><label class="half" for="star3half" title="Meh - 3.5 stars"></label>
                            <input type="radio" id="star3" name="rating" class="emotion-style-element_custom" value="3"><label class="full" for="star3" title="Meh - 3 stars"></label>
                            <input type="radio" id="star2half" name="rating" class="emotion-style-element_custom" value="2.5"><label class="half" for="star2half" title="Kinda bad - 2.5 stars"></label>
                            <input type="radio" id="star2" name="rating" class="emotion-style-element_custom" value="2"><label class="full" for="star2" title="Kinda bad - 2 stars"></label>
                            <input type="radio" id="star1half" name="rating" class="emotion-style-element_custom" value="1.5"><label class="half" for="star1half" title="Meh - 1.5 stars"></label>
                            <input type="radio" id="star1" name="rating" class="emotion-style-element_custom" value="1"><label class="full" for="star1" title="Sucks big time - 1 star"></label>
                            <input type="radio" id="starhalf" name="rating" class="emotion-style-element_custom" value="0.5"><label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
                        </fieldset>
                    </div>
                    <p class="e_f" style="text-align:center;"><textarea max-row="6"class="form-control intro_call_comment" id="intro_call_comment" type="text" placeholder="(Optional) Any Suggestions" ></textarea></p>
        ...
        <div class="modal-content" style="border-radius:8px;">
            <div class="modal-body">
                <div class="sec_liv_book modal_body_content">
                    ...
                    <p class="e_f" style="text-align:center;"><textarea max-row="6"class="form-control intro_call_comment" id="feedback_comment" type="text" placeholder="Give your valuable comment(Optional)" ></textarea></p>
                    <div style="text-align:center;">
                        <!-- <div class="referal_submit" id="r_cancel">Cancel</div> -->
                        <!-- <div class="referal_submit" id="i_submit">Submit</div> -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="border-radius:8px;">
            ...
            <div class="modal-body referal_modal-header">
                ...
                <div class="referal_text">Invite your friend and both of you can enjoy {{$extend_day}} days extra on your memberships.</div>
                <div class="r_code">{{$users->referal_code}}</div>
            </div>
            <div class="bottom_referal">
                <div class="col col_referal" onclick="r_pop_close()">
                    <a id="sharewa" href="https://api.whatsapp.com/send?text=Use%20my%20referral%20code%20{{$users->referal_code}}%20for%20a%20<?php echo $extend_day?>%20day%20extension%20on%20your%201st%20LivEzy%20plan%20purchase. https%3A%2F%2Flivezy.com" title="WhatsApp" target="_blank">
                        <img class="img-whats-app whatsapp_green" style="height:26px;" src="fitness/images/whatsapp.png">
                    </a>
                </div>
                <div class="col col_referal" onclick="copy(this)" data-code="Your referral code {{$users->referal_code}}">
                    <i class="far fa-copy copy_blue"></i>
                </div>
                <div class="col col_referal" onclick="r_pop_close()">
                    <a id="sharefb" href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Flivezy.com&amp;title=Use%20my%20referral%20code%20{{$users->referal_code}}%20for%20a%20<?php echo $extend_day?>%20day%20extension%20on%20your%201st%20LivEzy%20plan%20purchase." title="Facebook" target="_blank">
        ...
        <div class="modal-content" style="border-radius:8px;">
            ...
            <div class="modal-body">
                <ul class="pause_ul">
                    ...
                    <li class="pause_li">
                        A scheduled pause can be cancelled with no penalty up to 24 hours prior to the start date of the pause.
                    </li>
                    <li class="pause_li">
                        Upon cancelling a scheduled pause within 24 hours of the start date of the pause, a penalty of 3 days will be deducted from your total available pause days.
                    </li>
                </ul>
            </div>
            ...
            <div class="modal-body">
                <ul class="pause_ul">
                    <li class="pause_li ne_li renew_li">
                        <input type="radio" name="renew_plan" value="existing" checked class="pause-input pause_date renew_checkbox"> Existing Plan: <?php echo ucfirst($users->plan);?> (<?php echo ucfirst($users->member_type);?>)
                    </li>
                    <li class="pause_li ne_li renew_li">
                        <input name="renew_plan" value="new" class="pause-input pause_date renew_checkbox" type="radio"> New Plan
                    </li>
                    <li class="pause_li ne_li renew_li" style="text-align:center;">
                        <button class="pause-input-btn" id="renew_continue">Continue</button><button class="pause-input-btn renew_cancel_btn" data-dismiss="modal" >Cancel</button>
                    </li>
                    <li class="pause_li ne_li renew_li" id="renew_data_cnfrm" style="text-align:center;list-style:none;color:#ff0000b8;">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <ul class="pause_ul">
                    <li class="pause_li ne_li renew_li">
                        <input type="radio" name="renew_coach" value="existing" checked class="pause-input pause_date renew_checkbox"> Continue with Same Coach
                    </li>
                    <li class="pause_li ne_li renew_li">
                        <input type="radio" name="renew_coach" value="new" class="pause-input pause_date renew_checkbox"> Get a New Coach
                    ...
                    <li class="pause_li ne_li renew_li" style="text-align:center;list-style:none;">
                        <button class="pause-input-btn proceed_btn" id="renew_coach_button">Proceed</button>
...
<div id="plus_or_premium" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <ul class="pause_ul">
                    <li class="pause_li ne_li renew_li">
                        <input type="radio" name="get_plus_premium" value="plus" checked class="pause-input pause_date renew_checkbox"> Get LivEzy Plus Coach
                    </li>
                    <li class="pause_li ne_li renew_li">
                        <input type="radio" name="get_plus_premium" value="premium" class="pause-input pause_date renew_checkbox"> Get LivEzy Premium Coach
                    </li>
                    <li class="pause_li ne_li renew_li" style="text-align:center;list-style:none;padding: 12px; margin-right: 20px;">
                        <button class="pause-input-btn proceed_btn" id="get_plus_or_premium">Proceed</button>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="modal-content" style="border-radius:8px;">
            <div class="modal-body">
                <div class="sec_liv_book modal_body_content congo_pop_up">
                    ...
                    <p class="e_f" style="text-align:center"><input maxlength="6"class="form-control" type="text" id="referal_code" placeholder="Enter Referal Code" /></p>
...
if($pop_up){
    ...
    <style>
        ...
        a.btn.btn-primary.pay__:active{
            background: #187FDE;
            border:none;
        }
        span.number-member{
        ...
        .inside_date.active, .book_live_btn, .p_c_header, .l_d.active, .active_filter, .book_live_btn_today, .start_outside, .nav-item.active, .ui_modal-header{
            background: #187FDE;
        } */
        .start_outside{
            width: 90vw;
        ...
        /* .header_book_live{
            background: linear-gradient(96.22deg, #187FDE 5.19%, #187FDE 97.18%);
        } */
        .left_d_b, .left_d_b_pause{
            /* top:280px; */
            /* top: 29.5%; */
            top:340px;
        }
        .v_m_b, .v_c_r, .second_liv_carousel{
            color: #187FDE;
        }
        /* .ques-all-new, .profile_outside, .slider:before{
            background-image: linear-gradient(280deg , #187FDE, #187FDE);
        } */
        /* fieldset{
            background-image: linear-gradient(280deg , #187FDE, #187FDE)!important;
        } */
        .r_code{
            background: #187FDE;
        }
...
.act_i{
    ...
    .m_i_d_n{
            ...
            .rm_headeer{
                display: block;
                color: white;
                background-image: url(fitness/images/new_d_banner.png);
                background-size: cover;
                /* height: 128px; */
                /* height: 58px; */
                height: 109px;
...
<div id="pause_static_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius:8px;">
            <div class="modal-body pause_modal-header">
                ...
                <div class="p_c_header">
                    <div class="pause_icon_static">
                        <img src="fitness/images/Pause_icon.png" class="img-responsive" style="height: 26px;/* position: absolute; */margin-top: 15px;">
                    </div>
                </div>
            <div class="pacuse_content_static">
                ...
                <p class="pcs_2">{{date('d/m/Y',strtotime($pause_on_data[0]->start_date))}}  to  {{date('d/m/Y',strtotime($pause_on_data[0]->end_date))}}</p>
                <p class="pcs_3">Your subscription will resume from {{date('d/m/Y',strtotime($pause_on_data[0]->end_date.' + 1 days'))}}.</p>
                <?php
                }
                ?>
                <p class="pcs_4">Also, we request you to update your weight &amp; physique on whatsapp, before and after this pause period so we can stay on track!</p>
            </div>
 </div>
  ...
  <!-- <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; 2018-<span id="copyright"></span><script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script> <strong><span> Liv Ezy</span></strong>. All Rights Reserved
      </div>
...
<script>
    $('#renew_coach_button').on('click', function() {
        ...
        if ($("input[name='renew_coach']:checked").val() == 'existing') {
            ...
            console.log('From Get a New Coach');
            $('#coach_confirmation_on_renewal').modal('hide');
    ...
    // For Premium if user opt to get a new coach
    $('#get_plus_or_premium').on('click', function() {

    if ($("input[name='get_plus_premium']:checked").val() == 'plus') {
        $('#plus_or_premium').modal('hide');
        $('#package_bought').click();
    } else {
        console.log('From Get a New Coach - Plus');
        $('#plus_or_premium').modal('hide');
 ...
 <script>
    ...
    if('<?php echo $users->user_status;?>'=='2' || '<?php echo $users->user_status;?>'=='3' || '<?php echo $users->user_status;?>'=='4'){
    var firebaseConfig = {
    ...
    static_msg('Your head coach will reach out to you shortly on WhatsApp requesting full body pictures in order to customize your plan. Also, if you have any blood tests done recently, please share it as it can help us customize your plan better');
    }
    if('<?php echo $users->user_status;?>'=='5' && '<?php echo $users->member_type?>'!='Live Session'){
    static_msg('Thank you for sharing your pictures. Your head coach will customize and share your workout and diet plan at the earliest');
    }
    if('<?php echo $users->user_status;?>'=='6' && '<?php echo $users->member_type?>'!='Live Session'){
    static_msg('Your plan has been shared! You can access it by selecting the \'view plan\' option on the dashboard. Please go through the same and schedule a call with your head coach through the link provided on WhatsApp');
    }
    if('<?php echo $users->user_status;?>'=='7' && '<?php echo $users->member_type?>'!='Live Session'){
    static_msg('You\'re all set. <br>Looking forward to start this journey with you!');
    }
    ...
    let success_temp=`<div class="sec_liv_book">
    <p class="e_f t_r">Are you sure you want to cancel your pause?
    </p>
    </div>`;
    //date('d/m/Y',strtotime($pause_on_data[0]->end_date))
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response=='1'){
                                toastr.success('Pause Cancelled successfully');
                                let success_temp=`<div class="sec_liv_book">
                                <p class="e_f t_r">Your pause from ${s_d} to ${e_d} has been cancelled
                                </p>
                                </div>`;
                                swal({
                                    html: success_temp,
                            ...
                            swal({
                                    ...
                                    $('.upcoming_pause_carousel').slick('slickGoTo',$('.first_box_upcoming_pause').length);
                                }).catch(swal.noop)
                            }
    ...
    var equipment='None';
        ...
        switch(sess_name) {
            case 'HIIT':
                desc='Involves short bursts of intense exercise alternated with low-intensity recovery periods. Great way to shed weight and improve endurance.';
                rename_sess='HIIT';
                break;
            case 'SNC':
                desc='A training method focused on improving strength & endurance while helping participants build a great physique and all round functional fitness.';
                rename_sess='DB SNC';
                equipment='Dumbbells';
                break;
            case 'Yoga':
                desc='A variety of asanas, meditation and breathing techniques. Helps in managing stress and gaining functional fitness as well. ';
                rename_sess='Power Yoga';

                break;
            case 'Dance':
                desc='A full body aerobic workout, divided into different genres of music which makes the experience fun and very intense ';
                rename_sess='Dance Fitness';
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response=='1'){
                                ...
                                var tm_z=convertTZ(start_date+' '+start_time,'<?php echo isset($_COOKIE['user_time_zone'])?$_COOKIE['user_time_zone']:'Asia/Kolkata'?>');
    ...
    if(condition_text=='Cancel'){
        var temp=`<div class="sec_liv_book"><p class="e_f t_r">Are you sure you want to cancel?</p></div>`;
        swal({
                html: temp,
                showCancelButton: true,
                confirmButtonText: 'Yes',
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response=='1'){
                                ...
                                let success_temp=`<div class="sec_liv_book"><p class="e_f t_r">Session cancelled successfully</p></div>`;
                                swal({
                                    html: success_temp,
                                    showCancelButton: false,
                                    confirmButtonText: 'Ok',
    ...
    function clockUpdate(d,f,booked_status) {
        var date = new Date();
        date=new Date((typeof date === "string" ? new Date(date) : date).toLocaleString("en-US", {timeZone: '<?php echo isset($_COOKIE['user_time_zone'])?$_COOKIE['user_time_zone']:'Asia/Kolkata'?>'}));
        ...
        if(filter_type.length>1){
            //console.log($('.live_sess_block').parent())
                ...
                if($('#'+$('.zoom_live_view.active').attr('data-id')+' .filter_'+filter_type).length==0){
                    $('#'+$('.zoom_live_view.active').attr('data-id')).append('<div class="img_est"><p class="err_txt err_txt_style">'+session_name_change(filter_type)+'</p><img class="img-responsive error_img" src="fitness/images/'+filter_type+'.png"><p class="err_txt">Uh oh, session unavailable. Let\'s try another one?</p></div>');
                }else{
                        $('#'+$('.zoom_live_view.active').attr('data-id')+' .img_est').remove()
                }
        }else{
  ...
  <script>
        ...
        $(document).ready(function() {
            ...
            $('#profile_dob').on('change',function(){
                ...
                if(user_age<18){
                    let success_temp=`<div class="sec_liv_book"><p class="e_f t_r">This is to confirm that you have obtained the consent of your legal guardian or parents for the usage of our services.</p></div>`;
        ...
        $(document).ready(function(){
            ...
            if(user_status=='8'){
                // var whatsapp_no = '+919663488580'; //Support number after purchase
                var user_msg='<?php echo $users->head_coach?'Hi '.$users->head_coach.' ':'Hi Coach';?>';
                $('.whats-app-div').on('click',function(){
                    window.open('https://api.whatsapp.com/send/?phone=+'+whatsapp_no+'&text='+user_msg+'&app_absent=0','_blank')
                })
            }
            if(user_status=='1'){
                // var whatsapp_no='+917022292711'; //Sales number before purchase
                $('.whats-app-div').on('click',function(){
            ...
            $('.contact-whatsapp').on('click',function(){
                window.open('https://api.whatsapp.com/send/?phone=+919916127422&text=Hi+Liv%20+Ezy&app_absent=0','_blank')
            })
...
$('.emotion-style-element_custom').on('click',function(){
    ...
    $('#r_submit_new').on('click',function(){
        ...
        $.ajax({
                type:'post',
                data:{'r_code':$('#referal_code_new').val(),'member_type':data_pay_retrive.description},
                url:'/referal_code_check',
                success:function(response){
                    if(response){
                        toastr.success('Congrats! Referal code applied successfully.');
                        let congo_html=`Congratulations! you have got ${response} days extension in membership.`;
...
?>
    <script>
            // $(document).ready(function(){
            //     var user_status = '<?php echo $user_data->user_status; ?>';
            //     var coach_det_id = localStorage.getItem('coach_det_id') ? localStorage.getItem('coach_det_id') : null;
            //     var data_pay_retrive=JSON.parse(localStorage.getItem("user_plan_pay"));
            ...
            //                                 global:true,
            //                                 async:false,
            //                                 url: '/sendSubscriptionInvoice?desc='+data_pay_retrive.description+'&member_plan_id='+data_pay_retrive.plan_id+'&plan_id='+response.razorpay_payment_id+'&subscription_id='+sub + '&coach_det_id=' + coach_det_id,
            //                                 success: function (data) {
...
<script type="text/javascript">
    $( window ).on("load", function() {
        ...
        if(localStorage.getItem("reload_window")){
            ...
            setTimeout(function(){ $('#'+link).click(); $('.splash').css('display','none');$('.new_web').css('opacity',1);}, 2700);
        }else{
            // $('.p_d').css('display','none');
            $('#dashboard').click();
