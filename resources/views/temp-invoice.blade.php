				...
				<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
					<tr>
						<td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #00a5b5">
							<a href="https://tenable.com"><img class="top-image" src="fitness/images/ral_inv_header.png" style="line-height: 1;width: 600px;" alt="Tenable Network Security"></a>
						</td>
					</tr>
					<tr>
						<td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								<tr>
									<td class="head-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 28px;line-height: 34px;font-weight: bold; text-align: center;">
										<div class="mktEditable" id="main_title">
											LIV EZY ONLINE FITNESS PRIVATE LIMITED
										</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<img class="top-image" src="fitness/images/image_plan.jpg" width="560"/><br><br>
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										Hello Fitness Junky<br><br>

										Thank you for choosing us, our next step is to choose your start date
...
<div id="address" class="mktEditable">
										<b>Liv Ezy Online Fitness Pvt Ltd.</b><br>
                            #987 S.T.Bed, 6th Cross<br>  4th Block, Kormangala <br> Bangalore, IN 560034<br>
                            <a style="color: #00a5b5;" href="https://www.livezy.com#contactus">Contact Us</a>
</div>
									</td>
								</tr>
							</table>
