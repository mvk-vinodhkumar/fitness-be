...
;(function($, document, window, undefined) {
    ...
    $.extend(Plugin.prototype = {
        ...
        emotionStyle: function() {
            var styles = "."+this.styleCode+"{margin-right:3px;border-radius: 50%;cursor:pointer;opacity:0.7;display: inline-block;font-size:"
        ...
        renderEmotion: function () {
            ...
            var bgEmotion = ['angry','disappointed','meh', 'happy', 'inlove'];
            ...
            for (var i = 1; i <= count; i++) {
                console.log(bgEmotion[i]);
                emotionDiv = "<div class='"+this.styleCode+"' data-index='" + i + "'>"+emotionsArray[bgEmotion[(parseInt(i)-1)]]+"</div>";
