...
-------------------------------------------------------
Writee WordPress Theme Copyright 2016-2018 Scissor Themes
Writee WordPress Theme is distributed under the terms of the GNU GPL
-------------------------------------------------------

/*========= Credits =========*/

Writee bundles the following third-party resources:
...
cssus.js Copyright (c) 2006-2010 Stephen M. McKamey
License: MIT
Source: http://cssuseragent.org/

FitVids.js
License: FitVids is released under the WTFPL, which is GNU GPL compatible (http://www.gnu.org/licenses/license-list.html#WTFPL).
Source: Chris Coyier - http://css-tricks.com + Dave Rupert - http://daverupert.com
...
Bundled header images and images included Credit goes to the Unsplash 
