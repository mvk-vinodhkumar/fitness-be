...
if ( ! function_exists ( 'writee_enqueue_styles_scripts' ) ) {
	function writee_enqueue_styles_scripts() {
		...
		wp_enqueue_style('WRT-main-style', $writee_uri_path . '/assets/css/style-ltr.css?v1', null, false, 'all');
		...
		/*********************************************************/
		wp_enqueue_script( 'WRT-main-js', $writee_uri_path . '/assets/js/main.js?v1', $writee_uri_path . '/assets/js/main.js?v1', array('jquery'), '1.0.0', true);
